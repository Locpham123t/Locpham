...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>lộc Bịp chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "lộc Bịp", HidePremium = false, IntroText = "lộc Bịp⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("lộc Bịp SCRIPT")
W:AddLabel("Discordlộc Bịp")
local Section = W:AddSection({
    Name = "Status"
})
